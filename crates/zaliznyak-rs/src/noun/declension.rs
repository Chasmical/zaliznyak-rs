...
mod tests {
    ...
    fn simple_stem_types() {
        ...
        assert_eq!(decl("лицо́", "с 5d"), [
            ...
            "ли́ца, ли́ц, ли́цам, ли́ца, лица́ми, ли́цах",
        ]);
    ...
    fn vowel_alternation() {
        ...
        assert_eq!(decl("серьга́", "ж 3*f"), [
            ...
            "се́рьги, серё́г, се́рьгам, се́рьги, се́рьгами, се́рьгах",
        ]);
        ...
        assert_eq!(decl("кольцо́", "с 5*d"), [
            ...
            "ко́льца, коле́ц, ко́льцам, ко́льца, ко́льцами, ко́льцах",
        ]);
        ...
        assert_eq!(decl("овца́", "жо 5*d"), [
            ...
            "о́вцы, ове́ц, о́вцам, ове́ц, о́вцами, о́вцах",
        ]);
        ...
        assert_eq!(decl("лыжня́", "ж 2*b"), [
            ...
            "лыжни́́, лыжне́й, лыжня́м, лыжни́, лыжня́ми, лыжня́х",
        ]);
    ...
    fn ye_yo_alternation() {
        ...
        assert_eq!(decl("середа́", "ж 1f', ё"), [
            "середа́, середы́, середе́, середу́, середо́й, середе́",
